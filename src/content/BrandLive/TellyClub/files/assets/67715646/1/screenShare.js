...
ScreenShare.prototype.requestShare = async function () {
    ...
    Networking.instance.requestScreenShare(self.shareId, (error, data) => {
        ...
        if (error) {
            ...
            var yes = (e) => {
                e.stopPropagation();
                this.videoController.script.videoController.shareScreen(this.shareId);
...
ScreenShare.prototype.createScreenMaterial = function (video) {
    ...
    video.addEventListener('canplaythrough', function (e) {
        ...
        // newer engines multiply the emissive map by the emissive color,
        // which defaults to black - force white or the video renders black
        self.screenMaterial.emissive = pc.Color.WHITE;
        self.screenMaterial.emissiveIntensity = 1;
